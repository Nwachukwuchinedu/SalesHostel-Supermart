...
export const products: Product[] = [
  { id: "PROD001", name: "Organic Fuji Apples", uniqueName: "Apples", costPrice: 1.50, sellingPrice: 2.99, quantityAvailable: 100, tags: ["organic", "fruit", "fresh"], description: "Fresh and crispy Fuji apples, certified organic." },
  { id: "PROD002", name: "Artisanal Whole Wheat Bread", uniqueName: "Bread", costPrice: 2.00, sellingPrice: 4.50, quantityAvailable: 50, tags: ["bakery", "bread", "healthy"], description: "A loaf of freshly baked whole wheat bread." },
  { id: "PROD003", name: "Unsweetened Almond Milk", uniqueName: "Almond Milk", costPrice: 2.50, sellingPrice: 3.75, quantityAvailable: 75, tags: ["vegan", "dairy-free", "milk"], description: "Unsweetened almond milk, a great dairy alternative." },
  { id: "PROD004", name: "Boneless Chicken Breast", uniqueName: "Chicken", costPrice: 6.00, sellingPrice: 9.99, quantityAvailable: 30, tags: ["meat", "poultry", "protein"], description: "Boneless, skinless chicken breast, sold by the pound." },
  { id: "PROD005", name: "Sharp Cheddar Cheese Block", uniqueName: "Cheddar", costPrice: 3.00, sellingPrice: 5.25, quantityAvailable: 40, tags: ["dairy", "cheese"], description: "A block of sharp cheddar cheese." },
];
